...
- GitHub Copilot CLI (standalone `copilot` command; see https://github.com/github/copilot-cli)
- [GitHub Copilot App](https://github.com/github/app) (generally available)
